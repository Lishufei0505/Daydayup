...
from yolort.v5.utils.augmentations import Albumentations, augment_hsv, copy_paste, letterbox, mixup, random_perspective
from yolort.v5.utils.general import (DATASETS_DIR, LOGGER, NUM_THREADS, check_dataset, check_requirements, check_yaml, clean_str,
...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(self,
        ...
        self.hyp = hyp
        # self.batch_size = batch_size   #  这是我加的。
